...
import { Theme, Link, Image, Strong, Text, Box, Section, Icon, LinkBox, Hr, Input, Button } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section background="linear-gradient(264.47deg, #000848 29.39%, #000848 93.49%)" padding="36px 0 36px 0" quarkly-title="Header">
			...
			>
				<Text margin="0px 0px 0px 0px" color="#ffffff" font="30px sans-serif">
					<Strong
